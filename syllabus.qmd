...
-   Scott LaCombe (`slacombe@smith.edu`).Wright Hall 201. My hours will be held on Tuesdays 11-12, Wednesdays 10-11, and Thurdsays 4:15-5:15. Tuesdays and Wednesdays are by appointment slots ([sign up here](https://calendar.google.com/calendar/u/0/selfsched?sstoken=UUVsekFOdmJUYzVyfGRlZmF1bHR8MGY0NWUyMWJlMTk3M2ExMzc4YTdmMzM1NGI0MDY5Zjc)), and Thursdays are "group" office hours, meaning I have Wright 238 reserved and no appointment is required. \#### Description and Goals
...
4.  **In-Class R Projects** \[15%\]: The R projects are assigned without any prior notice. The goal of these in-class projects is to give timely feedback on your understanding of the current material before the course moves on to new material. These projects are open book and sometimes be assigned as group work. However, each student is expected to write their own code and a report including the reasonable interpretations.

5.  **Final Project and Participation** \[25%\]: For your final project you will be conducting a statistical investigation on a topic of your group's choosing. These projects will be done in groups of 3 (your choice of partner). You will use an existing dataset to answer a research question using statistical analysis (either multiple regression, or logistic regression). This project will include several check ins throughout the semester, and we will have 10-minute visual presentations the last week of class, with the final project being due during finals week. Throughout the semester we will have class time discussing how to choose a research question, finding data, etc. The goal of this project is to give you a firsthand look at how to engage in statistical analysis.

#### Summary

```{r, echo=FALSE, message=FALSE, warning=FALSE}
library(knitr)
Assignment <- c("Homework", "Participation", "Exams", "In Class R Projects",
                "Final Project", "Final Grade")
`Percent of Total` <- c("20%", "10%", "30%", "15%", "25%", "100%")
`Due Date` <- c("Fridays", "Daily", "TBD", "Fridays after assigned", "Finals Week", "")
